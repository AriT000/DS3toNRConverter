...
def main():
    parser = argparse.ArgumentParser(
        description='Convert DS3 SpEffectVfxParam CSV rows to Nightreign-compatible schema using a Nightreign target/template CSV.'
    )
    parser.add_argument(
        '--source',
        default='SpEffectVfxParam_midir.csv',
        help='Path to the DS3 source CSV (default: SpEffectVfxParam_midir.csv)',
    )
    parser.add_argument(
        '--target',
        default='SpEffectVfxParam_caligo.csv',
        help='Path to the Nightreign target/template CSV (default: SpEffectVfxParam_caligo.csv)',
    )
    parser.add_argument(
        '--output',
        default='SpEffectVfxParam_midir_DS3toNR.csv',
        help='Path to write the converted CSV (default: SpEffectVfxParam_midir_DS3toNR.csv)',
    )
