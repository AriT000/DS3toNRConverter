...
def main() -> None:
    ...
    parser.add_argument("--source", default="SpEffectParam_midir.csv", help="Path to the DS3 source CSV")
    parser.add_argument("--target", default="SpEffectParam_caligo.csv", help="Path to the Nightreign target/template CSV")
    parser.add_argument("--output", default="SpEffectParam_midir_DS3toNR.csv", help="Path to write the converted CSV")
