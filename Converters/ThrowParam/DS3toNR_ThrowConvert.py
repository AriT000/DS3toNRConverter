...
def main():
    parser = argparse.ArgumentParser(
        description='Convert DS3 ThrowParam CSV rows to Nightreign-compatible schema using a Nightreign target/template CSV.'
    )
    parser.add_argument(
        '--source',
        default='ThrowParam_midir.csv',
        help='Path to the DS3 source CSV (default: ThrowParam_midir.csv)',
    )
    parser.add_argument(
        '--target',
        default='ThrowParam_caligo.csv',
        help='Path to the Nightreign target/template CSV (default: ThrowParam_caligo.csv)',
    )
    parser.add_argument(
        '--output',
        default='ThrowParam_midir_DS3toNR_fixed.csv',
        help='Path to write the converted CSV (default: ThrowParam_midir_DS3toNR_fixed.csv)',
    )
